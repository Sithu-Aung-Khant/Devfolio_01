...
const IntroSection = () => {
  return (
    <section id="intro">
      <div className="container-2xl mx-auto p-4 md:h-dvh lg:px-24 xl:px-40 2xl:px-72 pt-20 md:pt-24">
        ...
        <div className="md:flex items-end">
          <div className="md:pl-20 relative">
            <div className="absolute z-10 top-6 md:top-40 md:left-0 lg:left-20">
              <div className="w-28 h-3 md:w-40 md:h-5 bg-brown03 dark:bg-dim_white md:ml-10"></div>
            </div>
            <img
